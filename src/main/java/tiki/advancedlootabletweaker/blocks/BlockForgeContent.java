...
public class BlockForgeContent extends BlockContent implements IHasGeneratedModel, ITileEntityProvider {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	private static boolean keepinventory;
	private final ForgeRepresentation forge;
	
	public BlockForgeContent(ForgeRepresentation forge)
	{
		super(forge);
		this.forge = forge;
	...
	{
		return new TileEntityForge(false, false, this.forge.getBaseHeatingSpeed(), this.getLocalizedName(), this.getRegistryName());
	}
