...
public class BlockForgeFuelContent extends BlockForgeContent implements IHasGeneratedModel, ITileEntityProvider {
	...
	{
		return new TileEntityForge(true, state.getValue(REQUIRES_IGNITION), this.forge.getBaseHeatingSpeed(), this.getLocalizedName(), this.getRegistryName());
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityForge(true, getStateFromMeta(meta).getValue(REQUIRES_IGNITION), this.forge.getBaseHeatingSpeed(), this.getLocalizedName(), this.getRegistryName());
	}
