...
public class ModInfo {
	...
	public static final String VER = "1.0.1-1.12.2";
	public static final String LOAD_AFTER = "required-after:FML;required-after:advancedlootableweapons@[1.4.0,);required-before:contenttweaker@[1.12.2-4.9.0,);";
